...
**Last Update:** Wed, 14 Jan 2026 18:36:04 GMT
...
### 1. [Verizon Wireless outage puts phones in SOS mode without cell service](https://www.bleepingcomputer.com/news/mobile/verizon-wireless-outage-puts-phones-in-sos-mode-without-cell-service/)
...
### 2. [Microsoft updates Windows DLL that triggered security alerts](https://www.bleepingcomputer.com/news/microsoft/microsoft-updates-windows-dll-that-triggered-security-alerts/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 3. [AI Agents Are Becoming Privilege Escalation Paths](https://thehackernews.com/2026/01/ai-agents-are-becoming-privilege.html)
...
### 4. [ConsentFix debrief: Insights from the new OAuth phishing attack](https://www.bleepingcomputer.com/news/security/consentfix-debrief-insights-from-the-new-oauth-phishing-attack/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 5. [Hackers Exploit c-ares DLL Side-Loading to Bypass Security and Deploy Malware](https://thehackernews.com/2026/01/hackers-exploit-c-ares-dll-side-loading.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
...
### 6. [Reprompt attack hijacked Microsoft Copilot sessions for data theft](https://www.bleepingcomputer.com/news/security/reprompt-attack-let-hackers-hijack-microsoft-copilot-sessions/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
Researchers identified an attack method dubbed "Reprompt" that could allow attackers to infiltrate a user's Microsoft Copilot session and issue commands to exfiltrate sensitive data. [...]

### 7. [Cloud marketplace Pax8 accidentally exposes data on 1,800 MSP partners](https://www.bleepingcomputer.com/news/security/cloud-marketplace-pax8-accidentally-exposes-data-on-1-800-msp-partners/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 8. [Fortinet Fixes Critical FortiSIEM Flaw Allowing Unauthenticated Remote Code Execution](https://thehackernews.com/2026/01/fortinet-fixes-critical-fortisiem-flaw.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
...
### 9. [Victorian Department of Education says hackers stole students’ data](https://www.bleepingcomputer.com/news/security/victorian-department-of-education-notifies-parents-of-data-breach/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 10. [New Research: 64% of 3rd-Party Applications Access Sensitive Data Without Justification](https://thehackernews.com/2026/01/new-research-64-of-3rd-party.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
...
### 11. [Microsoft: Windows 365 update blocks access to Cloud PC sessions](https://www.bleepingcomputer.com/news/microsoft/microsoft-windows-365-update-blocks-access-to-cloud-pc-sessions/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 12. [Microsoft Fixes 114 Windows Flaws in January 2026 Patch, One Actively Exploited](https://thehackernews.com/2026/01/microsoft-fixes-114-windows-flaws-in.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
...
### 13. [Monroe University says 2024 data breach affects 320,000 people](https://www.bleepingcomputer.com/news/security/monroe-university-says-2024-data-breach-affects-320-000-people/)
**Source:** Bleeping Computer | **Tags:** `Security` `Malware` `CVE`
...
### 14. [Critical Node.js Vulnerability Can Cause Server Crashes via async_hooks Stack Overflow](https://thehackernews.com/2026/01/critical-nodejs-vulnerability-can-cause.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
...
### 15. [PLUGGYAPE Malware Uses Signal and WhatsApp to Target Ukrainian Defense Forces](https://thehackernews.com/2026/01/pluggyape-malware-uses-signal-and.html)
**Source:** The Hacker News | **Tags:** `Security` `Vulnerabilities` `Threats`
